...
export default function Page() {
  return (
    <div className="container mx-auto space-y-4">
      ...
      <p>
        We are Treasure (Middleworld, Inc.) ("Company," "we," "us," "our"). We
        ...
        or by mail to 2538 E 22nd St, Brooklyn, NY 11235.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and Treasure,
      ...
      <div>
        <h3 className="text-xl font-bold">1. OUR SERVICES</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">2. INTELLECTUAL PROPERTY RIGHTS</h3>
        <p>
      ...
      <h4 className="font-bold text-lg">Your use of our services</h4>
      <p>
        ...
        internal business purpose. Except as set out in this section or
      ...
      <h4 className="font-bold text-lg">Your submissions</h4>
      <p>
        ...
        compensation to you. You are responsible for what you post or upload: By
      ...
      <div>
        <h3 className="text-xl font-bold">3. USER REPRESENTATIONS</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">4. PROHIBITED ACTIVITIES</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">5. USER GENERATED CONTRIBUTIONS</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">6. CONTRIBUTION LICENSE</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">7. SERVICES MANAGEMENT</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">8. TERM AND TERMINATION</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">10. GOVERNING LAW</h3>
        <p>
          These Legal Terms shall be governed by and defined following the laws
          of Delaware, United States. Treasure and yourself irrevocably consent
          that the courts of Delaware shall have exclusive jurisdiction to
          resolve any dispute which may arise in connection with these Legal
          Terms.
        </p>
      </div>
      <div>
        <h3 className="text-xl font-bold">11. DISPUTE RESOLUTION</h3>
        <p>
          These Legal Terms shall be governed by and defined following the laws
          of Delaware, United States. Treasure and yourself irrevocably consent
          that the courts of Delaware shall have exclusive jurisdiction to
      ...
      <h4 className="text-lg font-bold">Informal Negotiations</h4>
      <p>
      ...
      <h4 className="text-lg font-bold">Binding Arbitration</h4>
      <p>
        ...
        be standard for corporations of Delaware. The seat, or legal place, or
        arbitration shall be Delaware. The language of the proceedings shall be
        in English. The governing law of these Legal Terms shall be substantive
        law of Delaware.
      </p>
      <h4 className="text-lg font-bold">Restrictions</h4>
      <p>
      ...
      <div>
        <h3 className="text-xl font-bold">12. CORRECTIONS</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">13. DISCLAIMER</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">14. LIMITATIONS OF LIABILITY</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">15. INDEMNIFICATION</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">16. USER DATA</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">18. MISCELLANEOUS</h3>
        <p>
      ...
      <div>
        <h3 className="text-xl font-bold">19. CONTACT US</h3>
        <p>
