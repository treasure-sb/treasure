      ...
      <div className="space-y-4">
        ...
        {prebooked ? (
          <ol className="space-y-4 list-decimal list-outside ml-5">
            <li>
              Once approved, you will receive email confirmation of your table
              passes and will be featured as a vendor on the event page
            </li>
          </ol>
        ) : (
          <ol className="space-y-4 list-decimal list-outside ml-5">
            ...
            <li>
              You will receive email confirmation of your table passes and will
              be featured as a vendor on the event page
            </li>
          </ol>
        )}
      </div>
