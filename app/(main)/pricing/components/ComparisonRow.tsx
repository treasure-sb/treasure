...
export default function ComparisonRow({
  ...
  <div className=" w-[100%] h-[10%] flex-row flex " style={{
    ...
    <div className="justify-center w-1/4 items-center flex align-middle">
      ...
      {col1Text && <p className="text-center font-bold justify-center w-full my-auto" >{col1Text}</p>}
    </div>
    <div className="justify-center w-1/4 items-center flex align-middle">
      ...
      {col2Text && <p className="text-center font-bold justify-center w-full my-auto">{col2Text}</p>}
    </div>
    <div className="justify-center w-1/4 items-center flex align-middle">
      ...
      {col3Text && <p className="text-center font-bold justify-center w-full my-auto">{col3Text}</p>}
    </div>
  </div>)}