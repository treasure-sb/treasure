...
export default function PlanCard({
    ...
    return <div style ={{backgroundColor: color }}className="flex min-h-[428px] w-[320px] flex-col rounded-3xl p-8">
        <div className="ml-4">
            {recommended && <div className="self-center h-10"><Button className="rounded-3xl absolute right-6 top-4" size="sm" style={{backgroundColor: "black", color: "black" }}>
            ...
            <Button className="rounded-3xl" size="lg" style={{backgroundColor:backgroundColor === "black" ? "73D08D" : "black", color: backgroundColor === "black" ? "black" : "white", }}>
