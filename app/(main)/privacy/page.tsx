...
export default function Page() {
  return (
    <div className="container mx-auto space-y-4">
      ...
      <p>
        This privacy notice for Treasure (Middleworld, Inc.) ("we," "us," or
      ...
      <ul className="list-disc ml-8">
        ...
        <li>
          Download and use our mobile application (Treasure), or any other
      ...
      <p>
        <span className="font-semibold">Questions or concerns?</span> Reading
      ...
      <h3 className="text-xl font-bold">SUMMARY OF KEY POINTS</h3>
      ...
      <p>
        <span className="font-semibold">What are your rights?</span> Depending
        on where you are located geographically, the applicable privacy law may
        mean you have certain rights regarding your personal information. Learn
        more about your privacy rights.
      </p>
      <p>
        <span className="font-semibold">How do you exercise your rights? </span>{" "}
      ...
      <p>
        ...
        <Link href="https://stripe.com/privacy" className="text-blue-500">
      ...
      <p>
        <span className="font-semibold">Application Data</span> If you use our
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> We only process your
      ...
      <ul className="list-disc space-y-2 ml-8">
        ...
        <li>
          ...
          personal information for some of the purposes described to:
          <ul>
            <li>
      ...
      <ul className="ml-8 space-y-2 list-disc">
        ...
        <li>
          ...
          your location for one (1) months. You may revoke your consent anytime
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> We may use cookies
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> If you choose to
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> We keep your
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> We aim to protect
      ...
      <div>
        <h3 className="text-xl font-bold">9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
        <p>
          <span className="font-semibold">In Short: </span> In some regions,
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> If you are a
          resident of California, Colorado, Utah, Connecticut or Virginia, you
      ...
      <p className="font-semibold">California Residents</p>
      <p>
      ...
      <p className="font-semibold underline">CCPA Privacy Notice</p>
      <p>
        This section applies only to California residents. Under the California
        Consumer Privacy Act (CCPA), you have the rights listed below. The
      ...
      <p className="font-semobold underline">
      ...
      <p className="font-semibold">Colorado Residents</p>
      <p>
      ...
      <p>
        ...
        appeal our decision, please contact usw within forty-five (45) days of
      ...
      <p className="font-semibold">Connecticut Residents</p>
      <p>
      ...
      <p className="font-semibold">Utah Residents</p>
      <p>
      ...
      <p className="font-semibold">Virginia Residents</p>
      ...
      <p>You may submit a data subject access request.</p>
      <p>
      ...
      <p>
        ...
        decision, please contact us. Within sixty (60) days of receipt of an
        ...
        reasons for the decisions. If your appeal is denied, you may contact the
      ...
      <div>
        ...
        <p>
          <span className="font-semibold">In Short: </span> Yes, we will update
