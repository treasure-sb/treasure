  ...
  return (
    ...
    >
      <Link
        ...
        className="bg-primary text-background rounded-md col-span-2 p-10 hover:translate-y-[-0.5rem] transition duration-500 relative group "
      >
      ...
      <Link
        ...
        className="border-[1px] border-primary rounded-md p-10 hover:translate-y-[-0.5rem] transition duration-500 relative group"
      >
        <div className="absolute inset-0 group-hover:bg-black group-hover:bg-opacity-50 transition duration-500 rounded-md" />
      ...
      <Link
        ...
        className="bg-tertiary text-background rounded-md p-10 hover:translate-y-[-0.5rem] transition duration-500 relative group "
      >
      ...
      <Link
        ...
        className="bg-secondary col-span-2 rounded-md p-10 hover:translate-y-[-0.5rem] transition duration-500 relative group"
      >
        <div className="absolute inset-0 group-hover:bg-black group-hover:bg-opacity-50 transition duration-500" />
