...
export default function PreviewEvent() {
  ...
  return (
    <div className="md:max-w-[1160px] mx-auto flex flex-col md:flex-row md:justify-between md:space-x-14 mt-12 pb-40">
      ...
      <div className="text-left w-full max-w-xl md:max-w-2xl mx-auto relative z-20 space-y-3">
        ...
        {venueMap && <VenueMap venueMap={null} venueMapPublicUrl={venueMap} />}
        <HostedBy />
      </div>
    </div>
  );
