...
export default function FeaturedEventImageLink({
  ...
  return (
    ...
    >
      ...
      <div className="bg-background text-foreground dark:text-background dark:bg-foreground p-2 md:p-4 h-fit md:group-hover:bg-background/90 md:group-hover:dark:bg-foreground/90 transition duration-300 rounded-b-md">
