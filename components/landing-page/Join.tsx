...
export default function Join() {
  return (
    <div className="relative mx-[-16px] sm:mx-[-32px] py-16 md:py-28 overflow-hidden dark:text-background">
      ...
      <div className="relative w-full md:max-w-4xl m-auto flex flex-col items-center justify-center px-6 space-y-10 md:space-y-20">
        <p className="text-[30px] md:text-6xl font-semibold text-center leading-10 md:leading-[1.5]">
        ...
        <LandingButton
          ...
          text="Create Your Event with Treausre"
        />
      </div>
    </div>
  );
