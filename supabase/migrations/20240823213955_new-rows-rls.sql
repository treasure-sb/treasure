...
alter table "public"."orders" add column "fees_paid" real;

alter table "public"."subscription_products" add column "service_fee" real not null default '0'::real;

alter table "public"."subscription_products" add column "stripe_fee" boolean;
