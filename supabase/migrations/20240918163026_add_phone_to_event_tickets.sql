...
alter table "public"."subscriptions" drop constraint "subscription_invoices_user_id_fkey";

alter table "public"."event_tickets" add column "phone" text;

alter table "public"."subscriptions" add constraint "subscriptions_user_id_fkey" FOREIGN KEY (user_id) REFERENCES profiles(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
