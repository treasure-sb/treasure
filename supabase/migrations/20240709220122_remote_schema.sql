...
ALTER FUNCTION "public"."purchase_table"("table_id" "uuid", "event_id" "uuid", "user_id" "uuid", "purchase_quantity" integer) OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."temporary_vendors"
    ADD CONSTRAINT "temporary_vendors_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");
...
GRANT ALL ON FUNCTION "public"."purchase_table"("table_id" "uuid", "event_id" "uuid", "user_id" "uuid", "purchase_quantity" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."purchase_table"("table_id" "uuid", "event_id" "uuid", "user_id" "uuid", "purchase_quantity" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."purchase_table"("table_id" "uuid", "event_id" "uuid", "user_id" "uuid", "purchase_quantity" integer) TO "service_role";
