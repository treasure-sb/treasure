...
drop function if exists "public"."purchase_table"(table_id uuid, event_id uuid, user_id uuid, purchase_quantity integer, amount_paid double precision, promo_id uuid, fees_paid double precision);

drop function if exists "public"."purchase_tickets"(ticket_id uuid, event_id uuid, user_id uuid, purchase_quantity integer, email text, amount_paid double precision, metadata json, promo_id uuid, fees_paid double precision);
